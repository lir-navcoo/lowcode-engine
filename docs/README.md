...
> **From-scratch rewrite** of `alibaba/lowcode-engine` v1.3.2 under the `@monbolc` npm scope. 14 packages, L0–L7 complete, 966 tests passing, zero `@alilc`/`@alifd`/`@supu` references in source.
...
- **Test**: `yarn test` (vitest 2.1, happy-dom, @testing-library/react 16) — **966 tests / 85 files, 0 failures**
