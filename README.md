...
>
> **SapuLowcodeEngine** is a from-scratch rewrite of `alibaba/lowcode-engine` v1.3.2, modernized for React 19, BaseUI, and Tailwind v4. 14 packages, 652 unit tests + 11 e2e, 0 third-party deps added.
